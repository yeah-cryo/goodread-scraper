  ...
  _createClass(HyperFormula, [{
    ...
    value: function getFillRangeData(source, target) {
      ...
      if (sourceRange.sheet !== targetRange.sheet) {
        throw new _errors.SheetsNotEqual(sourceRange.sheet, targetRange.sheet);
      }
...
HyperFormula.buildDate = "23/09/2021 13:29:59";
/**
 * A release date.
 *
 * @category Static Properties
...
HyperFormula.releaseDate = "23/09/2021";
/**
